 ...
 * Affiche l'état de configuration de chaque canal (Slack, Email, Telegram)
 * et permet de tester les alertes manuellement.
 *
 * Props:
 *   brand : string
 */
export default function AlertsPanel({ brand }) {
  ...
  const [testing, setTesting]       = useState(null); // canal en cours de test
  ...
  return (
    <div className="ap2-wrapper">
      ...
      {/* Footer : déclencheurs automatiques */}

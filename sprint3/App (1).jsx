...
import PromptComparator from './components/PromptComparator';   // SPRINT 3
import AlertsPanel from './components/AlertsPanel';             // SPRINT 3
import {
...
export default function App() {
  ...
  // Tab actif — navigation sections (Sprint 3)
    ...
    <div className="app-layout">
      ...
      <div className="main-content">
        <div className="page-content">
          ...
          {/* Progression streaming — visible sur tous les onglets */}
          ...
          {/* ── ONGLET PROMPTS (Sprint 3) ── */}
          {activeTab === 'prompts' && (
            <PromptComparator brand={config.brand} />
          )}

          {/* ── ONGLET ALERTES (Sprint 3) ── */}
          {activeTab === 'alerts' && (
